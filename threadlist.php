...
<body>
    ...
    if($method=='POST'){
        ...
        if($showAlert){
            ...
            <strong>Success!</strong> Your Thread Has Been Added! We Will Let You Know When Community Respond To Your Thread.
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="title" id="title" aria-describedby="title"
            placeholder="Please Ask Your problem">
    </div>
    ...
    <p class="lead">
    <h1 class="py-2">Start A Discussion</h1>
    <b>You Are Not Logged in. Please Login First To Start A Discussion.</b>  
    </p>
</div>';
    }
    ?>
    ...
    <div class="container mb-5">
        ...
        echo '<div class="media my-3">
            ...
            <div class="media-body">'.
                '<h5 class="mt-0"><a class="text-dark" href="/forum/thread.php?threadid=' . $id . '">' . $title . '</a></h5> ' . $desc . ' </div> ' . '<p class="font-weight-bold my-0">Asked By:' . $row2['user_email'] . ' at ' . $thread_time . ' </p> ' . ' </div>';
        }
        if($noResult){
